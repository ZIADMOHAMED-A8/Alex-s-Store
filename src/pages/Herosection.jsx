        ...
        <div className={styles.hero_section}>
            <div className="container {styles.a7a}" id={styles.cont}  style={{display:'flex',justifyContent:'space-between'}}>
                ...
                <div className={styles.buttons2}>
                    ...
                    <div><a style={{textDecoration: "none",color:'blue'}} href="https://www.facebook.com/profile.php?id=100066723254988">Facebook</a></div>
                    <div><a style={{textDecoration: "none",color:'green'}} href="https://whatsapp.com/channel/0029VbAb7hgJuyA8QZxqRp2b">Whatsapp</a></div>
